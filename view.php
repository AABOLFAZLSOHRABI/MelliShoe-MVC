...
class view
{
                ...
                <footer class="bg-white">
                    <div
                        ...
                        <address
                            ...
                            <div class="flex flex-col items-center gap-2 text-center"><strong
                            ...
                            <div class="flex flex-col items-start gap-2 text-center"><strong
                        ...
                        <div class="absolute left-8 top-[225px] flex max-w-[260px] flex-col items-center gap-2 text-center nav:static"
                        ...
                        <div
                            ...
                            <p><strong class="font-bold">ایمیل کفش ملی</strong>: AbolfazlSohrabi@mellishoes.ir</p>
                        </div>
                    </div>
                </footer>
            </div>
    ...
    public function index($products, $reviews, $slides)
    {
        $this->header();
        ?>
        <main class="flex flex-col gap-16 mobile:gap-12">
            <!-- slide -->
            <section class="flex w-full flex-col gap-6" aria-label="اسلایدر">
                <div class="relative w-full overflow-hidden rounded-[24px] bg-[#f8f5f0]">
                    <div id="promo-slider"
                        ...
                        foreach ($slides as $slide) {
                            ?>
                            <article id="promo-slide-<?php echo $slide['id']; ?>"
                                class="h-full min-w-full flex-[0_0_100%] snap-start">
                                <img class="block h-full w-full object-cover max-w-full" src="<?php echo $slide['image']; ?>"
            ...
            <section class="mx-auto flex w-full max-w-[1440px] flex-col gap-14 px-[60px] mobile:gap-7 mobile:px-5" id="offers"
                ...
                <div class="flex items-center gap-6 overflow-x-auto pb-2 [direction:rtl] [scroll-snap-type:x_mandatory]">
                    <?php
                    $index = 0;
                        ...
                        <article class="w-[312px] flex-[0_0_312px] [direction:rtl] [scroll-snap-align:start]">
                            <figure
                                ...
                                <div
                                    ...
                                    <img class="absolute inset-0 h-full w-full object-cover" src="<?php echo $item['image']; ?>"
                                        alt="کفش روزمره کودک" />
                                </div><label
                            ...
                            <div
                                ...
                                <p
                                    ...
                                    <strong class="font-bold"><?php echo number_format($item['price']); ?> تومان</strong>
                                </p>
                            </div>
                        </article>
                        <?php
                    ...
                    foreach ($products as $item) {
                        ...
                        <article class="w-[312px] flex-[0_0_312px] [direction:rtl] [scroll-snap-align:start]">
                            ...
                            <div
                                ...
                                <p class="text-[16px] leading-[22px] tracking-[-0.48px] text-black"><?php echo $item['brand']; ?>
                                </p>
                                <p
                                    class="flex flex-row-reverse gap-2 whitespace-nowrap text-[16px] leading-[22px] tracking-[-0.48px] text-black">
                                    <?php
                                    if ($item['old_price'] == 0 || $item['old_price'] == null) {
                                        ?>
                                        <strong class="font-bold"><?php echo number_format($item['price']); ?> تومان</strong>
                                        <?php
                                        ...
                                        ?> <del
                                            class="text-[#a5a5a5] no-underline"><?php echo number_format($item['old_price']); ?>
                                            تومان</del>
                                        <strong class="font-bold"><?php echo number_format($item['price']); ?> تومان</strong><?php
                                    }
                                    ?>
                                </p>
                            </div>
                    ...
                    foreach ($reviews as $item) {
                        ...
                        <article
                            ...
                            <h3
                                ...
                                <span
                                    class="grid h-6 w-6 place-items-center rounded-full bg-[#01ab31] text-[15px] text-white">✓</span><?php echo $item['customer_name']; ?>
                            </h3>
